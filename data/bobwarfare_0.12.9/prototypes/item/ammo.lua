...
data:extend(
{
...

  {
    ...
    icon = "__bobwarfare__/graphics/icons/impact-bullet-magazine.png",
    flags = {"goes-to-main-inventory"},
    subgroup = "bob-ammo",
    order = "a[basic-clips]-b[bullet-magazine-impact]",
    stack_size = 100,
    magazine_size = 25,
    ammo_type =
    {
...

  {
    ...
    icon = "__bobwarfare__/graphics/icons/shotgun-impact-shell.png",
    flags = {"goes-to-main-inventory"},
    subgroup = "bob-ammo",
    order = "f[shotgun-impact-shell]",
    stack_size = 500,
    magazine_size = 5,
    ammo_type =
    {
      ...
      action =
      {
        ...
        {
          type = "projectile",
          projectile = "shotgun-impact-projectile",
          starting_speed = 1,
          direction_deviation = 0.4,
          range_deviation = 0.4,
          max_range = 15
...
--[[
...

  {
    ...
    icon = "__bobwarfare__/graphics/icons/impact-rocket.png",
    flags = {"goes-to-main-inventory"},
    ammo_type = bobmissileammo("rocket", "bob-impact-rocket"),
    subgroup = "bob-ammo",
