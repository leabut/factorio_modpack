data:extend(
{
...

  {
    ...
    icon = "__bobwarfare__/graphics/icons/impact-bullet-projectile.png",
    flags = {"goes-to-main-inventory"},
    subgroup = "bob-ammo-parts",
    order = "f[bullet-projectile-impact]",
    stack_size = 100
  },

  {
    type = "item",
    name = "impact-bullet",
    icon = "__bobwarfare__/graphics/icons/impact-bullet.png",
    flags = {"goes-to-main-inventory"},
    subgroup = "bob-ammo-parts",
    order = "f[bullet-impact]",
    stack_size = 100
  },
...

  {
    ...
    icon = "__bobwarfare__/graphics/icons/missile-warhead-impact.png",
    flags = {"goes-to-main-inventory"},
    subgroup = "bob-ammo-parts",
    order = "f[impact-rocket-warhead]",
    stack_size = 100
  },
