...
{
  {
    ...
    prerequisites = {"tanks", "titanium-processing", "advanced-electronics-2"},
    effects =
    {
      {
        type = "unlock-recipe",
...

  {
    ...
    name = "tanks-3",
    icon = "__base__/graphics/technology/tanks.png",
    prerequisites = {"tanks-2", "tungsten-alloy-processing", "nitinol-processing", "ceramics", "advanced-electronics-3"},
    effects =
    {
      {
        type = "unlock-recipe",
