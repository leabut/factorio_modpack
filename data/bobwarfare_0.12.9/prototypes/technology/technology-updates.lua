if data.raw.tool["science-pack-4"] then
  bobmods.lib.replace_science_pack("bob-turrets-5", "alien-science-pack", "science-pack-4")
  bobmods.lib.replace_science_pack("bob-laser-turrets-5", "alien-science-pack", "science-pack-4")
  bobmods.lib.replace_science_pack("bob-sniper-turrets-3", "alien-science-pack", "science-pack-4")

  bobmods.lib.replace_science_pack("bob-laser-rifle-ammo-4", "alien-science-pack", "science-pack-4")
  bobmods.lib.replace_science_pack("bob-laser-rifle-ammo-5", "alien-science-pack", "science-pack-4")
  bobmods.lib.add_new_science_pack("bob-laser-rifle-ammo-6", "science-pack-4", 1)

  bobmods.lib.replace_science_pack("basic-laser-defense-equipment-5", "alien-science-pack", "science-pack-4")
  bobmods.lib.add_new_science_pack("basic-laser-defense-equipment-6", "science-pack-4", 1)

  bobmods.lib.replace_science_pack("tanks-3", "alien-science-pack", "science-pack-4")


  bobmods.lib.replace_science_pack("bullet-damage-5", "alien-science-pack", "science-pack-4")
  bobmods.lib.replace_science_pack("bullet-speed-5", "alien-science-pack", "science-pack-4")
  bobmods.lib.add_new_science_pack("bullet-damage-6", "science-pack-4", 1)
  bobmods.lib.add_new_science_pack("bullet-speed-6", "science-pack-4", 1)

  bobmods.lib.replace_science_pack("shotgun-shell-damage-5", "alien-science-pack", "science-pack-4")
  bobmods.lib.replace_science_pack("shotgun-shell-speed-5", "alien-science-pack", "science-pack-4")
  bobmods.lib.add_new_science_pack("shotgun-shell-damage-6", "science-pack-4", 1)
  bobmods.lib.add_new_science_pack("shotgun-shell-speed-6", "science-pack-4", 1)

  bobmods.lib.add_new_science_pack("rocket-damage-5", "science-pack-4", 1)
  bobmods.lib.add_new_science_pack("rocket-speed-5", "science-pack-4", 1)
  bobmods.lib.add_new_science_pack("rocket-damage-6", "science-pack-4", 1)
  bobmods.lib.add_new_science_pack("rocket-speed-6", "science-pack-4", 1)

  bobmods.lib.replace_science_pack("bob-tank-cannon-damage-5", "alien-science-pack", "science-pack-4")
  bobmods.lib.replace_science_pack("bob-tank-cannon-speed-5", "alien-science-pack", "science-pack-4")
  bobmods.lib.add_new_science_pack("bob-tank-cannon-damage-6", "science-pack-4", 1)
  bobmods.lib.add_new_science_pack("bob-tank-cannon-speed-6", "science-pack-4", 1)

  bobmods.lib.replace_science_pack("bob-laser-rifle-damage-5", "alien-science-pack", "science-pack-4")
  bobmods.lib.replace_science_pack("bob-laser-rifle-speed-5", "alien-science-pack", "science-pack-4")
  bobmods.lib.add_new_science_pack("bob-laser-rifle-damage-6", "science-pack-4", 1)
  bobmods.lib.add_new_science_pack("bob-laser-rifle-speed-6", "science-pack-4", 1)

  bobmods.lib.replace_science_pack("gun-turret-damage-5", "alien-science-pack", "science-pack-4")
  bobmods.lib.add_new_science_pack("gun-turret-damage-6", "science-pack-4", 1)

  bobmods.lib.replace_science_pack("laser-turret-damage-5", "alien-science-pack", "science-pack-4")
  bobmods.lib.replace_science_pack("laser-turret-speed-5", "alien-science-pack", "science-pack-4")
  bobmods.lib.add_new_science_pack("laser-turret-damage-6", "science-pack-4", 1)
  bobmods.lib.add_new_science_pack("laser-turret-speed-6", "science-pack-4", 1)

  bobmods.lib.replace_science_pack("bob-sniper-turret-damage-5", "alien-science-pack", "science-pack-4")
  bobmods.lib.add_new_science_pack("bob-sniper-turret-damage-6", "science-pack-4", 1)
end
...
then
  ...
  data.raw.technology["bob-impact-bullets"].unit.ingredients = {{"science-pack-gold", 1},{"alien-science-pack-orange", 1}}
  data.raw.technology["bob-shotgun-impact-shells"].unit.ingredients = {{"science-pack-gold", 1},{"alien-science-pack-orange", 1}}
  data.raw.technology["bob-impact-rocket"].unit.ingredients = {{"science-pack-gold", 1},{"alien-science-pack-orange", 1}}
  ...
  if data.raw.tool["science-pack-4"] then
    bobmods.lib.replace_science_pack("bob-ap-bullets", "alien-science-pack", "science-pack-4")
    bobmods.lib.replace_science_pack("bob-shotgun-ap-shells", "alien-science-pack", "science-pack-4")
    bobmods.lib.replace_science_pack("bob-piercing-rocket", "alien-science-pack", "science-pack-4")

    bobmods.lib.replace_science_pack("bob-impact-bullets", "alien-science-pack", "science-pack-4")
    bobmods.lib.replace_science_pack("bob-shotgun-impact-shells", "alien-science-pack", "science-pack-4")
    bobmods.lib.replace_science_pack("bob-impact-rocket", "alien-science-pack", "science-pack-4")

    bobmods.lib.replace_science_pack("bob-acid-bullets", "alien-science-pack", "science-pack-4")
    bobmods.lib.replace_science_pack("bob-shotgun-acid-shells", "alien-science-pack", "science-pack-4")
    bobmods.lib.replace_science_pack("bob-acid-rocket", "alien-science-pack", "science-pack-4")

    bobmods.lib.replace_science_pack("bob-he-bullets", "alien-science-pack", "science-pack-4")
    bobmods.lib.replace_science_pack("bob-shotgun-explosive-shells", "alien-science-pack", "science-pack-4")
    bobmods.lib.replace_science_pack("bob-explosive-rocket", "alien-science-pack", "science-pack-4")

    bobmods.lib.replace_science_pack("bob-poison-bullets", "alien-science-pack", "science-pack-4")
    bobmods.lib.replace_science_pack("bob-shotgun-poison-shells", "alien-science-pack", "science-pack-4")
    bobmods.lib.replace_science_pack("bob-poison-rocket", "alien-science-pack", "science-pack-4")

    bobmods.lib.replace_science_pack("bob-flame-bullets", "alien-science-pack", "science-pack-4")
    bobmods.lib.replace_science_pack("bob-shotgun-flame-shells", "alien-science-pack", "science-pack-4")
    bobmods.lib.replace_science_pack("bob-flame-rocket", "alien-science-pack", "science-pack-4")
...
if data.raw.technology["alien-blue-research"] then
  bobmods.lib.add_technology_prerequisite ("bob-ap-bullets", "alien-blue-research")
  bobmods.lib.add_technology_prerequisite ("bob-shotgun-ap-shells", "alien-blue-research")
  bobmods.lib.add_technology_prerequisite ("bob-piercing-rocket", "alien-blue-research")
else
  bobmods.lib.add_technology_prerequisite ("bob-ap-bullets", "tungsten-processing")
  bobmods.lib.add_technology_prerequisite ("bob-shotgun-ap-shells", "tungsten-processing")
  bobmods.lib.add_technology_prerequisite ("bob-piercing-rocket", "tungsten-processing")
end

if data.raw.technology["alien-orange-research"] then
  bobmods.lib.add_technology_prerequisite ("bob-impact-bullets", "alien-orange-research")
  bobmods.lib.add_technology_prerequisite ("bob-shotgun-impact-shells", "alien-orange-research")
  bobmods.lib.add_technology_prerequisite ("bob-impact-rocket", "alien-orange-research")
end

if data.raw.technology["alien-purple-research"] then
  bobmods.lib.add_technology_prerequisite ("bob-acid-bullets", "alien-purple-research")
  bobmods.lib.add_technology_prerequisite ("bob-shotgun-acid-shells", "alien-purple-research")
  bobmods.lib.add_technology_prerequisite ("bob-acid-rocket", "alien-purple-research")
else
  bobmods.lib.add_technology_prerequisite ("bob-acid-rocket", "nitrogen-processing")
end

if data.raw.technology["alien-yellow-research"] then
  bobmods.lib.add_technology_prerequisite ("bob-he-bullets", "alien-yellow-research")
  bobmods.lib.add_technology_prerequisite ("bob-shotgun-explosive-shells", "alien-yellow-research")
  bobmods.lib.add_technology_prerequisite ("bob-explosive-rocket", "alien-yellow-research")
else
  bobmods.lib.add_technology_prerequisite ("bob-he-bullets", "explosives")
  bobmods.lib.add_technology_prerequisite ("bob-shotgun-explosive-shells", "explosives")
end

if data.raw.technology["alien-green-research"] then
  bobmods.lib.add_technology_prerequisite ("bob-poison-bullets", "alien-green-research")
  bobmods.lib.add_technology_prerequisite ("bob-shotgun-poison-shells", "alien-green-research")
  bobmods.lib.add_technology_prerequisite ("bob-poison-rocket", "alien-green-research")
end

if data.raw.technology["alien-red-research"] then
  bobmods.lib.add_technology_prerequisite ("bob-flame-bullets", "alien-red-research")
  bobmods.lib.add_technology_prerequisite ("bob-shotgun-flame-shells", "alien-red-research")
  bobmods.lib.add_technology_prerequisite ("bob-flame-rocket", "alien-red-research")
else
  bobmods.lib.add_technology_prerequisite ("bob-flame-bullets", "flammables")
  bobmods.lib.add_technology_prerequisite ("bob-shotgun-flame-shells", "flammables")
end


bobmods.lib.add_technology_recipe ("military-3", "rifle")
bobmods.lib.add_technology_recipe ("military-3", "sniper-rifle")

bobmods.lib.add_technology_recipe ("rocketry", "rocket-engine")
...
if data.raw.recipe["gun-cotton-synthetic"] then
  bobmods.lib.add_technology_recipe ("cordite-processing", "gun-cotton-synthetic")
end
