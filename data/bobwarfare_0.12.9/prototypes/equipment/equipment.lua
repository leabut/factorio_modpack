...
data.raw["battery-equipment"]["battery-mk2-equipment"].energy_source.buffer_capacity = "200KJ"
data.raw["battery-equipment"]["battery-mk2-equipment"].energy_source.input_flow_limit = "2MW"
data.raw["battery-equipment"]["battery-mk2-equipment"].energy_source.output_flow_limit = "2MW"
...
data:extend(
{
  ...
  },
  {
    ...
    {
      type = "electric",
      buffer_capacity = "7500KJ",
      input_flow_limit = "75MW",
      output_flow_limit = "75MW",
      usage_priority = "terciary"
    }
  },
  {
    ...
    energy_source =
    {
      ...
      input_flow_limit = "180MW",
      output_flow_limit = "180MW",
      usage_priority = "terciary"
    }
  },
}
...
data:extend(
{
--  bob_basic_laser_defense_equipment(name, sprite, buffer_capacity, energy_consumption, projectile, damage_modifier, cooldown, range)
  bob_basic_laser_defense_equipment("basic-laser-defense-equipment-2", "__bobwarfare__/graphics/equipment/basic-laser-defense-equipment-2.png", "26kJ", "12500J", "bob-green-laser", 1.5, 15, 16),
  bob_basic_laser_defense_equipment("basic-laser-defense-equipment-3", "__bobwarfare__/graphics/equipment/basic-laser-defense-equipment-3.png", "46kJ", "15kJ", "bob-blue-laser", 2.1, 12, 17),
  bob_basic_laser_defense_equipment("basic-laser-defense-equipment-4", "__bobwarfare__/graphics/equipment/basic-laser-defense-equipment-4.png", "71kJ", "17500J", "bob-purple-laser", 2.8, 10, 18),
  bob_basic_laser_defense_equipment("basic-laser-defense-equipment-5", "__bobwarfare__/graphics/equipment/basic-laser-defense-equipment-5.png", "101kJ", "20kJ", "bob-yellow-laser", 3.6, 8.5, 19),
  bob_basic_laser_defense_equipment("basic-laser-defense-equipment-6", "__bobwarfare__/graphics/equipment/basic-laser-defense-equipment-6.png", "136kJ", "22500J", "bob-white-laser", 4.5, 7.5, 20),
}
)
