...
if data.raw.unit["bob-titan-biter"]~=nil then
  ...
  if data.raw.item["small-alien-artifact-orange"] then
    table.insert(data.raw.unit["bob-titan-biter"].loot, { item = "small-alien-artifact-orange",  count_min = 1,  count_max = 3,  probability = 1 } )
  end
  if data.raw.item["small-alien-artifact-green"] then
    table.insert(data.raw.unit["bob-titan-biter"].loot, {  item = "small-alien-artifact-green",  count_min = 1,  count_max = 3,  probability = 1 } )
  end
  if data.raw.item["small-alien-artifact"] and data.raw.item["small-alien-artifact-blue"]==nil and data.raw.item["small-alien-artifact-orange"]==nil and data.raw.item["small-alien-artifact-green"]==nil then
    table.insert(data.raw.unit["bob-titan-biter"].loot, {  item = "small-alien-artifact",  count_min = 4,  count_max = 12,  probability = 1 } )
  else
    if data.raw.item["small-alien-artifact"] then
      table.insert(data.raw.unit["bob-titan-biter"].loot, {  item = "small-alien-artifact",  count_min = 1,  count_max = 3,  probability = 1 } )
    else
...
if data.raw.unit["bob-titan-spitter"]~=nil then
  ...
  if data.raw.item["small-alien-artifact-purple"] then
    table.insert(data.raw.unit["bob-titan-spitter"].loot, {  item = "small-alien-artifact-purple",  count_min = 1,  count_max = 3,  probability = 1 } )
  end
  if data.raw.item["small-alien-artifact-yellow"] then
  ...
  if data.raw.item["small-alien-artifact"] and data.raw.item["small-alien-artifact-purple"]==nil and data.raw.item["small-alien-artifact-yellow"]==nil and data.raw.item["small-alien-artifact-red"]==nil then
    table.insert(data.raw.unit["bob-titan-spitter"].loot, {  item = "small-alien-artifact",  count_min = 4,  count_max = 12,  probability = 1 } )
  else
    if data.raw.item["small-alien-artifact"] then
      table.insert(data.raw.unit["bob-titan-spitter"].loot, {  item = "small-alien-artifact",  count_min = 1,  count_max = 3,  probability = 1 } )
    else
...
if data.raw.unit["bob-behemoth-biter"]~=nil then
  ...
  if data.raw.item["small-alien-artifact-orange"] then
    table.insert(data.raw.unit["bob-behemoth-biter"].loot, { item = "small-alien-artifact-orange",  count_min = 1,  count_max = 3,  probability = 1 } )
  end
  if data.raw.item["small-alien-artifact-green"] then
  ...
  if data.raw.item["small-alien-artifact"] and data.raw.item["small-alien-artifact-blue"]==nil and data.raw.item["small-alien-artifact-orange"]==nil and data.raw.item["small-alien-artifact-green"]==nil and data.raw.item["small-alien-artifact-red"]==nil then
    table.insert(data.raw.unit["bob-behemoth-biter"].loot, {  item = "small-alien-artifact",  count_min = 4,  count_max = 12,  probability = 1 } )
  else
    if data.raw.item["small-alien-artifact"] then
      table.insert(data.raw.unit["bob-behemoth-biter"].loot, {  item = "small-alien-artifact",  count_min = 1,  count_max = 3,  probability = 1 } )
    else
      table.insert(data.raw.unit["bob-behemoth-biter"].loot, {  item = "alien-artifact",  count_min = 1,  count_max = 2,  probability = 0.5 } )
    end
  end
end
...
if data.raw.unit["bob-behemoth-spitter"]~=nil then
  ...
  if data.raw.item["small-alien-artifact-purple"] then
    table.insert(data.raw.unit["bob-behemoth-spitter"].loot, {  item = "small-alien-artifact-purple",  count_min = 1,  count_max = 3,  probability = 1 } )
  end
  if data.raw.item["small-alien-artifact-yellow"] then
  ...
  if data.raw.item["small-alien-artifact-blue"] then
    table.insert(data.raw.unit["bob-behemoth-spitter"].loot, {  item = "small-alien-artifact-blue",  count_min = 1,  count_max = 3,  probability = 1 } )
  end
  if data.raw.item["small-alien-artifact"] and data.raw.item["small-alien-artifact-blue"]==nil and data.raw.item["small-alien-artifact-purple"]==nil and data.raw.item["small-alien-artifact-yellow"]==nil and data.raw.item["small-alien-artifact-green"]==nil then
    table.insert(data.raw.unit["bob-behemoth-spitter"].loot, {  item = "small-alien-artifact",  count_min = 4,  count_max = 12,  probability = 1 } )
  else
    if data.raw.item["small-alien-artifact"] then
      table.insert(data.raw.unit["bob-behemoth-spitter"].loot, {  item = "small-alien-artifact",  count_min = 1,  count_max = 3,  probability = 1 } )
    else
      table.insert(data.raw.unit["bob-behemoth-spitter"].loot, {  item = "alien-artifact",  count_min = 1,  count_max = 2,  probability = 0.5 } )
    end
  end
end
