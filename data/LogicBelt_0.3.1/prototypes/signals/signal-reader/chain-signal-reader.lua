data:extend({
	{
		...
		result = "chain-signal-reader"
	},
	{
		type = "item",
		name = "chain-signal-reader",
		icon = "__LogicBelt__/graphics/signals/signal-reader/chain-signal-reader.png",
		flags = {"goes-to-quickbar"},
		subgroup = "lb-rail-signals",
		order = "02[reader]-02[chain]",
		place_result = "chain-signal-reader",
		stack_size = 50
	},
	{
		...
		minable = {mining_time = 1, result = "chain-signal-reader"},
		max_health = 80,
