...
{ 
	...
	},
	{
		...
		minable = {hardness = 0.2, mining_time = 0.5, result = "logic-signal-ghost"},
		max_health = 40,
		...
		platform_picture =
		{
			sheet=
			{
				filename = "__LogicBelt__/graphics/signals/logic-signal-ghost/logic-signal-ghost.png",
				priority = "very-low",
				width = 15,
				height = 15,
			}
