...
{ 
	{
		type = "item",
		name = "express-counter-transport-belt",
		icon = "__LogicBelt__/graphics/belts/counter-belt/express-counter-belt.png",
		flags = {"goes-to-quickbar"},
		subgroup = "lb-belts",
		order = "02[counter-belts]-03[express]",
		place_result = "express-counter-transport-belt",
		stack_size = 50
	},
	{
		type = "recipe",
		...
		result = "express-counter-transport-belt"
	},
	{
		type = "transport-belt",
		name = "express-counter-transport-belt",
		...
		minable = {hardness = 0.2, mining_time = 0.3, result = "express-counter-transport-belt"},
		max_health = 50,
...
table.insert(
	...
	{
		type = "unlock-recipe",
		recipe = "express-counter-transport-belt"
	}
)