...
{ 
	{
		type = "item",
		name = "extreme-counter-transport-belt",
		icon = "__LogicBelt__/graphics/belts/counter-belt/extreme-counter-belt.png",
		flags = {"goes-to-quickbar"},
		subgroup = "lb-belts",
		order = "02[counter-belts]-05[extreme]",
		place_result = "extreme-counter-transport-belt",
		stack_size = 50
	},
	{
		type = "recipe",
		...
		result = "extreme-counter-transport-belt"
	},
	{
		type = "transport-belt",
		name = "extreme-counter-transport-belt",
		...
		minable = {hardness = 0.2, mining_time = 0.3, result = "extreme-counter-transport-belt"},
		max_health = 50,
...
table.insert(
	...
	{
		type = "unlock-recipe",
		recipe = "extreme-counter-transport-belt"
	}
)