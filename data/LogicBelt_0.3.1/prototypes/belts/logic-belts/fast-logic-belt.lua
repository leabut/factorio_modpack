...
{ 
	{
		type = "item",
		name = "fast-logic-transport-belt",
		icon = "__LogicBelt__/graphics/belts/logic-belt/fast-logic-belt.png",
		flags = {"goes-to-quickbar"},
		subgroup = "lb-belts",
		order = "01[logic-belts]-02[fast]",
		place_result = "fast-logic-transport-belt",
		stack_size = 50
	},
	{
		type = "recipe",
		...
		result = "fast-logic-transport-belt"
	},
	{
		type = "transport-belt",
		name = "fast-logic-transport-belt",
		...
		minable = {hardness = 0.2, mining_time = 0.3, result = "fast-logic-transport-belt"},
		max_health = 50,
...
table.insert(
	...
	{
		type = "unlock-recipe",
		recipe = "fast-logic-transport-belt"
	}
)