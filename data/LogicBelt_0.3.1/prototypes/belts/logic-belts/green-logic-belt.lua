...
{ 
	{
		type = "item",
		name = "green-logic-transport-belt",
		icon = "__LogicBelt__/graphics/belts/logic-belt/green-logic-belt.png",
		flags = {"goes-to-quickbar"},
		subgroup = "lb-belts",
		order = "01[logic-belts]-06[green]",
		place_result = "green-logic-transport-belt",
		stack_size = 50
	},
	{
		type = "recipe",
		...
		result = "green-logic-transport-belt"
	},
	{
		type = "transport-belt",
		name = "green-logic-transport-belt",
		...
		minable = {hardness = 0.2, mining_time = 0.3, result = "green-logic-transport-belt"},
		max_health = 50,
...
table.insert(
	...
	{
		type = "unlock-recipe",
		recipe = "green-logic-transport-belt"
	}
)