...
{ 
	{
		type = "item",
		name = "basic-logic-transport-belt",
		icon = "__LogicBelt__/graphics/belts/logic-belt/basic-logic-belt.png",
		flags = {"goes-to-quickbar"},
		subgroup = "lb-belts",
		order = "01[logic-belts]-01[basic]",
		place_result = "basic-logic-transport-belt",
		stack_size = 50
	},
	{
		type = "recipe",
		...
		result = "basic-logic-transport-belt"
	},
	{
		type = "transport-belt",
		name = "basic-logic-transport-belt",
		...
		minable = {hardness = 0.2, mining_time = 0.3, result = "basic-logic-transport-belt"},
		max_health = 50,
...
table.insert(
	...
	{
		type = "unlock-recipe",
		recipe = "basic-logic-transport-belt"
	}
)