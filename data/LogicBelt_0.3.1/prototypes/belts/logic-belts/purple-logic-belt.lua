...
{ 
	{
		type = "item",
		name = "purple-logic-transport-belt",
		icon = "__LogicBelt__/graphics/belts/logic-belt/purple-logic-belt.png",
		flags = {"goes-to-quickbar"},
		subgroup = "lb-belts",
		order = "01[logic-belts]-07[purple]",
		place_result = "purple-logic-transport-belt",
		stack_size = 50
	},
	{
		type = "recipe",
		...
		result = "purple-logic-transport-belt"
	},
	{
		type = "transport-belt",
		name = "purple-logic-transport-belt",
		...
		minable = {hardness = 0.2, mining_time = 0.3, result = "purple-logic-transport-belt"},
		max_health = 50,
...
table.insert(
	...
	{
		type = "unlock-recipe",
		recipe = "purple-logic-transport-belt"
	}
)