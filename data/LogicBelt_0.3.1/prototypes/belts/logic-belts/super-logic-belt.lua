...
{ 
	{
		type = "item",
		name = "super-logic-transport-belt",
		icon = "__LogicBelt__/graphics/belts/logic-belt/super-logic-belt.png",
		flags = {"goes-to-quickbar"},
		subgroup = "lb-belts",
		order = "01[logic-belts]-04[super]",
		place_result = "super-logic-transport-belt",
		stack_size = 50
	},
	{
		type = "recipe",
		...
		result = "super-logic-transport-belt"
	},
	{
		type = "transport-belt",
		name = "super-logic-transport-belt",
		...
		minable = {hardness = 0.2, mining_time = 0.3, result = "super-logic-transport-belt"},
		max_health = 50,
...
table.insert(
	...
	{
		type = "unlock-recipe",
		recipe = "super-logic-transport-belt"
	}
)