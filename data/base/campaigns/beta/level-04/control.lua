...
script.on_init(function()
  ...
  recipe_list["basic-armor"].enabled = true
  ...
  local technology_list = game.player.force.technologies
  ...
  technology_list["inserter-stack-size-bonus-1"].enabled = true
  technology_list["inserter-stack-size-bonus-2"].enabled = true
  ...
  character.insert{name = "fast-transport-belt", count = 25}
  character.insert{name = "basic-inserter", count = 20}
  character.insert{name = "medium-electric-pole", count = 10}
  character.insert{name = "small-electric-pole", count = 15}
  character.insert{name = "basic-mining-drill", count = 10}
  character.insert{name = "basic-transport-belt-to-ground", count = 10}
  ...
  character.insert{name = "basic-bullet-magazine", count = 200}
  ...
  {
    {
      action = function()
        ...
        global.close_enemies = game.player.surface.find_entities_filtered({area=bb, type="unit"})
      end
    },
    {
    ...
    },
    {
      ...
      action = function()
        game.player.print({"msg-escaped"})
      end
    },
    {
      condition = story_elapsed_check(5),
      action = function()
        game.player.print({"msg-enemy-1"})
      end,
    },
    {
      condition = story_elapsed_check(5),
      action = function()
        game.player.print({"msg-escape-1"})
      end
    },
    {
      condition = story_elapsed_check(5),
      action = function()
        game.player.print({"msg-build-plane-1"})
      end
    },
    {
      condition = story_elapsed_check(5),
      action = function()
        game.player.print({"msg-build-plane-2"})
      end
    },
    {
      condition = story_elapsed_check(5),
      action = function()
        game.player.print({"msg-oil-introduction"})
      end
    },
    {
      condition = story_elapsed_check(5),
      action = function()
        game.player.set_goal_description({"goal-research-oil-processing"})
      end
    },
    {
      condition =
    ...
    },
    {
      ...
      action =
      function()
        game.player.print({"msg-setup-oil-industry-1"})
      end
    },
    {
      condition = story_elapsed_check(5),
      action =
      function()
        game.player.print({"msg-setup-oil-industry-2"})
      end
    },
    {
      condition = story_elapsed_check(5),
      action =
      function()
        game.player.print({"msg-setup-oil-industry-3"})
      end
    },
    {
      condition = story_elapsed_check(5),
      action =
      function()
        game.player.force.recipes["small-plane"].enabled = true
        game.player.set_goal_description({"goal-build-small-plane"})
      end
    },
    {
      condition = story_elapsed_check(5),
      action =
      function()
        game.player.print({"msg-setup-oil-industry-4"})
      end
    },
    {
      condition = function() return game.player.get_item_count("small-plane") >= 1 end,
    },
    {
      condition = story_elapsed_check(2),
      action =
      function()
        game.player.print({"msg-finished"})
      end
    },
    {
      condition = story_elapsed_check(5),
...
function on_win()
  game.player.set_ending_screen_data({"epilogue"}, "factorio-theme-3.png")
end
...
function handle_attacks()
  ...
  if game.player.character and global.attack_data.until_next_attack <= 0 then
    ...
    local unitssent = game.player.surface.set_multi_command{command = {type=defines.command.attack,
