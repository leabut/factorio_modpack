...
script.on_init(function()
  ...
  local technologylist = game.player.force.technologies
  ...
  character.insert{name = "basic-grenade", count = 7}
  character.insert{name = "fast-transport-belt", count = 128}
  character.insert{name = "fast-inserter", count = 45}
  ...
  character.insert{name = "stone-wall", count = 128}
  ...
  character.insert{name = "piercing-bullet-magazine", count = 100}
  ...
  character.insert{name = "steel-plate", count = 1000}
  ...
  techwreckage.insert{name = "defender-capsule", count = 10}
  ...
  {
    {
      ...
      action =
      function()
        game.player.print({"msg-wreck-location"})
      end
    },
    {
      ...
      action =
      function()
        game.player.print({"msg-wreck-motivation"})
      end
    },
    {
      condition = story_elapsed_check(5),
      action =
      function()
        game.player.print({"msg-wreck-guarded"})
      end
    },
    {
      condition = story_elapsed_check(5),
      action =
      function()
        game.player.print({"msg-wrech-technology"})
      end
    },
    {
      condition = story_elapsed_check(5),
    ...
    },
    {
      ...
      init =
      function(event)
        game.player.set_goal_description({"goal-get-wreckage"})
    ...
    },
    {
      ...
      function()
        ...
        return game.get_entity_by_tag("tech-wreckage") == game.player.opened or
    ...
    },
    {
      ...
      init =
      function(event)
        game.player.set_goal_description({"goal-get-computer"})
      end
    },
    {
      condition = function() return game.player.get_item_count("computer") > 0 end,
      action = function()
               game.player.print({"msg-got-it"})
             end,
    },
    {
      condition = story_elapsed_check(5)
