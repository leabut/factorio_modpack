...
{
  {
    ...
    order = "e-1[alien-science-pack-blue]",
    stack_size = 200,
    durability = 1,
  ...
  },
  {
    ...
    flags = {"goes-to-main-inventory"},
    subgroup = "science-pack",
    order = "e-2[alien-science-pack-orange]",
    stack_size = 200,
    durability = 1,
    durability_description_key = "description.science-pack-remaining-amount"
  },
  {
    ...
    flags = {"goes-to-main-inventory"},
    subgroup = "science-pack",
    order = "e-3[alien-science-pack-purple]",
    stack_size = 200,
    durability = 1,
    durability_description_key = "description.science-pack-remaining-amount"
  },
  {
    ...
    flags = {"goes-to-main-inventory"},
    subgroup = "science-pack",
    order = "e-4[alien-science-pack-yellow]",
    stack_size = 200,
    durability = 1,
    durability_description_key = "description.science-pack-remaining-amount"
  },
  {
    ...
    flags = {"goes-to-main-inventory"},
    subgroup = "science-pack",
    order = "e-5[alien-science-pack-green]",
    stack_size = 200,
    durability = 1,
    durability_description_key = "description.science-pack-remaining-amount"
  },
  {
    ...
    flags = {"goes-to-main-inventory"},
    subgroup = "science-pack",
    order = "e-6[alien-science-pack-red]",
    stack_size = 200,
    durability = 1,
    durability_description_key = "description.science-pack-remaining-amount"
  },
