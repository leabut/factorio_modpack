data:extend({

  {
    ...
    icon = "__Burner_Generator__/graphics/icons/burner-generator-icon.png",
 ...
 --       { position = {-1, 0} }
    ...
    structure =
    {
      left =
      {
        filename = "__Burner_Generator__/graphics/entity/burner-generator.png",
        priority = "extra-high",
        width = 121,
        height = 80,
        shift = {0.6,0}
    ...
    fire    =
{
...

  {
    ...
    {
      filename = "__Burner_Generator__/graphics/entity/blank.png",
      width = 50,
      height = 50,
      frame_count = 1,
      line_length = 8,
