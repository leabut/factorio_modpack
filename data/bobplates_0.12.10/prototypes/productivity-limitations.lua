...
bobmods.lib.add_productivity_limitations(gems)
bobmods.lib.add_productivity_limitations(alloys)
bobmods.lib.add_productivity_limitations(chemicals)
bobmods.lib.add_productivity_limitations(compounds)
bobmods.lib.add_productivity_limitations(electronics)
bobmods.lib.add_productivity_limitations(plates)
