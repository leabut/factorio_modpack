...
pipecoverspicturesCokery = function()
  return {
    north =
    {
      filename = "__Treefarm-AC__/graphics/icons/empty.png",
...
function assembler2pipepicturesBioreactor()
  return
  {
    ...
    east =
    {
      filename = "__Treefarm-AC__/graphics/entities/bioreactor/pipe-east.png",
      priority = "extra-high",
      width = 41,
      height = 40,
      shift = {-0.71875, 0}
    ...
    south =
    {
      filename = "__Treefarm-AC__/graphics/entities/bioreactor/pipe-south.png",
      priority = "extra-high",
      width = 41,
      height = 40,
      shift = {0.0625, -0.8}
    ...
    west =
    {
      filename = "__Treefarm-AC__/graphics/entities/bioreactor/pipe-west.png",
      priority = "extra-high",
      width = 41,
      height = 40,
      shift = {0.78125, 0.03125}
...
pipecoverspicturesBioreactor = function()
  return {
    north =
    {
      filename = "__Treefarm-AC__/graphics/icons/empty.png",
