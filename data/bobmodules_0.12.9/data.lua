...
local EnableProductivityLimitation = false

bobmods.modules.ProductivityHasSpeed = false

-- Stats for the modules per level.
bobmods.modules.SpeedPerLevel = 0.2
bobmods.modules.ConsumptionPerLevel = 0.15
bobmods.modules.PollutionPerLevel = 0.1
...
if bobmods and bobmods.config and bobmods.config.modules then
  ...
  if bobmods.config.modules.EnableProductivityLimitation ~= nil then
    EnableProductivityLimitation = bobmods.config.modules.EnableProductivityLimitation 
  end
...
if EnableProductivityLimitation == true then
